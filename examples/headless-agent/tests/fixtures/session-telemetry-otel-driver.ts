...
import { boot, resolveConfigPath } from '@clocky/clocky-app-boot'
import { recordFeedback } from '@clocky/clocky-command-feedback'
import { runFixtureTurn } from '@clocky/clocky-loader-smoke'
...
process.env.CLOCKY_TELEMETRY_E2E_URL = `http://127.0.0.1:${address.port}/v1/logs`
...
try {
  ...
  const mode = process.env.CLOCKY_TELEMETRY_E2E_MODE ?? 'FULL'
  if (mode !== 'FULL') {
