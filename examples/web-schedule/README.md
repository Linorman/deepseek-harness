...
This overlay opts one `clocky web` process into Schedule reminders without changing the shipped default Web composition:

```sh
clocky web --patch examples/web-schedule/cordis.yml
```
