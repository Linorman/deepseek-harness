 ...
 * `clocky-tool-bash`'s renderer: stdout, a marked stderr section, sandbox
 ...
 * results.
 *
 * @module @clocky/clocky-tool-pwsh/render
 */

import type { ShellProcessRead, ShellSandboxInfo, CollectedOutput } from '@clocky/clocky-shell'
...
/* jscpd:ignore-start -- deliberate twin of clocky-tool-bash/render.ts (Agent Note). */
