 ...
 * twin of `clocky-tool-bash`'s background adaptation.
 *
 * @module @clocky/clocky-tool-pwsh/background
 */

import type { ShellProcess } from '@clocky/clocky-shell'

/* jscpd:ignore-start -- deliberate twin of clocky-tool-bash/background.ts (Agent Note). */
