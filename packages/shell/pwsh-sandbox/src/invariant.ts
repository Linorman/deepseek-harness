/**
 * Package-owned invariant companion for `@clocky/clocky-pwsh-sandbox`.
 * @module @clocky/clocky-pwsh-sandbox/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-pwsh-sandbox'
