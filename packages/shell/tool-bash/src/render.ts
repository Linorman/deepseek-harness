 ...
 *
 * @module @clocky/clocky-tool-bash/render
 */

import type { ShellProcessRead, ShellRunResult, ShellSandboxInfo, CollectedOutput } from '@clocky/clocky-shell'
import type { SandboxMode } from '@clocky/clocky-sandbox'
import { escalationHintMarker, sandboxDenialMarker } from '@clocky/clocky-sandbox'
 ...
 * rendering story, owned by `@clocky/clocky-shell` so `clocky-tool-pwsh` reuses
 ...
 */
export { parseExitStatus, type ParsedExitStatus } from '@clocky/clocky-shell'
