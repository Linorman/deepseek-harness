 ...
 * @module @clocky/clocky-tool-pwsh-persistent
 */
...
import type { TerminalReadResult, TerminalSendResult, TerminalSessionId } from '@clocky/clocky-terminal'
...
const SHELL_PROMPT = '__CLOCKY_PERSISTENT_PWSH_PROMPT__ '
...
function markers(): CommandMarkers {
  ...
  return {
    start: `__CLOCKY_PERSISTENT_PWSH_START_${nonce}__`,
    end: `__CLOCKY_PERSISTENT_PWSH_END_${nonce}:`,
  }
}
