/**
 * Package-owned invariant companion for `@clocky/clocky-tool-pwsh-persistent`.
 * @module @clocky/clocky-tool-pwsh-persistent/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-tool-pwsh-persistent'
