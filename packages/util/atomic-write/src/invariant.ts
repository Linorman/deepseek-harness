/**
 * Package-owned invariant companion for `@clocky/clocky-atomic-write`.
 * @module @clocky/clocky-atomic-write/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-atomic-write'
