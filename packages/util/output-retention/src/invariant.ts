/**
 * Package-owned invariant companion for `@clocky/clocky-output-retention`.
 * @module @clocky/clocky-output-retention/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-output-retention'
