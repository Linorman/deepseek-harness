 ...
 *
 * Policy: a package brands the ids it owns — `CallId` in clocky-llm (tool-call
 * correlation), the shared agent/session `SessionId` in clocky-session, and
 * `JobId` in clocky-jobs. Branding is for ids that cross package boundaries and
