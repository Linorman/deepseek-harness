...
import type { SaveTextSpill } from '@clocky/clocky-spill'
import LocalSpillStore, { encodeSegment, privateRoot, saveTextFile, sessionDir } from '@clocky/clocky-spill-local'

let root: string

beforeEach(() => {
  root = mkdtempSync(join(tmpdir(), 'clocky-spill-test-'))
})
afterEach(() => {
