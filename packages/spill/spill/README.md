...
| Package | Role |
|---|---|
| `@clocky/clocky-spill` (this) | Service Definition: abstract service + vocabulary types |
| `@clocky/clocky-spill-local` | Service Provider: private session-scoped files on the host filesystem |
| `@clocky/clocky-spill-policy` | Consumer: the tool-result policy that spills oversized final results |
