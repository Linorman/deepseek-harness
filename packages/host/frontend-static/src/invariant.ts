/**
 * Package-owned invariant companion for `@clocky/clocky-host-frontend-static`.
 * @module @clocky/clocky-host-frontend-static/invariant
 */

import type { Context } from '@clocky/cordis'
import type { InvariantInstaller } from '@clocky/clocky-invariants'

const PACKAGE_NAME = '@clocky/clocky-host-frontend-static'
