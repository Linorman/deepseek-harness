/** Package-owned invariant companion for the directory-picker seam. @module @clocky/clocky-host-directory-picker/invariant */

import type { Context } from '@clocky/cordis'
import type { InvariantInstaller } from '@clocky/clocky-invariants'

const PACKAGE_NAME = '@clocky/clocky-host-directory-picker'
