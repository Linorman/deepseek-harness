/**
 * Package-owned invariant companion for `@clocky/clocky-host-apiproxy`.
 * @module @clocky/clocky-host-apiproxy/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-host-apiproxy'
