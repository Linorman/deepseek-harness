...
import type { AttachmentIdType, ImageAttachmentLimits, ImageAttachmentRef } from '@clocky/clocky-attachment'
 ...
 * the clocky-tools vocabulary into this schema and drift with it.
 */
