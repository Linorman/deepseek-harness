...
import type { AskUserQuestionItem } from '@clocky/clocky-user-questions/types'
import type { ApprovalOutcome, ApprovalRequestId } from '@clocky/clocky-user-approval/types'
...
import type { JsonValue, SessionEvent, SessionId } from '@clocky/clocky-session/types'
import type { ToolCallView, ToolResultView } from '@clocky/clocky-tools/presentation'
...
export type HostFrame =
   ...
   * owned by `@clocky/clocky-api-remotes` (`API_REMOTE_FORWARDED_EVENTS`),
