 ...
 *
 * @module @clocky/clocky-session-query
 */

import { Context, Service } from '@clocky/cordis'
import { Session, snapshotSessionEvent, type SessionId } from '@clocky/clocky-session'
import { foldSessionTitle } from '@clocky/clocky-session-title'
import type { SessionTitleSnapshot } from '@clocky/clocky-session-title'
import type {
