/**
 * Package-owned invariant companion for `@clocky/clocky-session-query`.
 * @module @clocky/clocky-session-query/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-session-query'
