/**
 * Package-owned invariant companion for `@clocky/clocky-tool-session-query`.
 * @module @clocky/clocky-tool-session-query/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-tool-session-query'
