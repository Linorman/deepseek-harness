/**
 * Package-owned invariant companion for `@clocky/clocky-sdk-protocol`.
 * @module @clocky/clocky-sdk-protocol/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-sdk-protocol'
