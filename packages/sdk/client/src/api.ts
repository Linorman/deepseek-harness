/**
 * High-level run API over {@link HarnessClient}: `Clocky` owns one
 ...
 * Mirrors the Python SDK's `Clocky`/`Session` pair.
 *
 * @module @clocky/clocky-sdk-client/api
 */
...
/**
 * Reusable SDK for running Clocky agent turns in a runtime
...
export class HarnessSession {
   ...
   */
  constructor(readonly harness: Clocky, readonly id: string) {}
