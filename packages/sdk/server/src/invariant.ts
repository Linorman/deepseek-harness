/**
 * Package-owned invariant companion for `@clocky/clocky-sdk-jsonrpc-server`.
 * @module @clocky/clocky-sdk-jsonrpc-server/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-sdk-jsonrpc-server'
