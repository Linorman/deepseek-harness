/**
 * Package-owned invariant companion for `@clocky/clocky-typert-protocol`.
 * @module @clocky/clocky-typert-protocol/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-typert-protocol'
