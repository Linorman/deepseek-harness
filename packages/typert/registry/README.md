...
The `@clocky/clocky-typert-registry/types` subpath contains the pure contribution and record contracts. [`clocky-typert-loader`](../loader/README.md) discovers and registers generated host artifacts in Loader compositions; direct `ctx.typert.register()` supports other composition owners.
