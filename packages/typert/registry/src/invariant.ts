/**
 * Package-owned invariant companion for `@clocky/clocky-typert-registry`.
 * @module @clocky/clocky-typert-registry/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-typert-registry'
