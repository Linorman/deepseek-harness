...
/**
 * Establish this process's proof that one CLOCKY_HOME entry and every ancestor
 ...
 * @param root - absolute `CLOCKY_HOME/attachments/v1` root.
...
export async function commitPreparedImageFile(
  ...
  // Establish CLOCKY_HOME itself against the filesystem root once per process.
