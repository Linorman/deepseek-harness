/** Local durable attachment backend rooted below `CLOCKY_HOME`. @module @clocky/clocky-attachment-local */
...
export class LocalAttachmentStore extends AttachmentStore {
  ...
  constructor(ctx: Context, config: Config) {
    super(ctx)
    this.root = resolve(join(resolveClockyHome(config.clockyHome), 'attachments', 'v1'))
