/** Package-owned invariant companion for `@clocky/clocky-attachment-local`. @module @clocky/clocky-attachment-local/invariant */

/* jscpd:ignore-start */
import type { Context } from '@clocky/cordis'
import type { InvariantInstaller } from '@clocky/clocky-invariants'

const PACKAGE_NAME = '@clocky/clocky-attachment-local'
