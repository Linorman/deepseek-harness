/**
 * Package-owned invariant companion for `@clocky/clocky-session-projection`.
 * @module @clocky/clocky-session-projection/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-session-projection'
