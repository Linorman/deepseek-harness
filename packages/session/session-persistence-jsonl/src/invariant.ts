/**
 * Package-owned invariant companion for `@clocky/clocky-session-persistence-jsonl`.
 * @module @clocky/clocky-session-persistence-jsonl/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-session-persistence-jsonl'
