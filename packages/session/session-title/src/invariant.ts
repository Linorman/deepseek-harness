/**
 * Package-owned invariant companion for `@clocky/clocky-session-title`.
 * @module @clocky/clocky-session-title/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-session-title'
