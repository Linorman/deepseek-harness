/**
 * Package-owned invariant companion for `@clocky/clocky-session-persistence`.
 * @module @clocky/clocky-session-persistence/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-session-persistence'
