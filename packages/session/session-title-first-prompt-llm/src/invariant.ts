/**
 * Package-owned invariant companion for `@clocky/clocky-session-title-first-prompt-llm`.
 * @module @clocky/clocky-session-title-first-prompt-llm/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-session-title-first-prompt-llm'
