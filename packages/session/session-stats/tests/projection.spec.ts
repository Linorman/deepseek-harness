...
import { sessionStatsProjectionDefinition } from '@clocky/clocky-session-stats/src/projection.ts'
import type { SessionStatsProjection } from '@clocky/clocky-session-stats/types'
