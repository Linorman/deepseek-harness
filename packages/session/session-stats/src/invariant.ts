/**
 * Package-owned invariant companion for `@clocky/clocky-session-stats`.
 * @module @clocky/clocky-session-stats/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-session-stats'
 ...
 * ids) are owned and runtime-checked by clocky-agent-loop and the session
 * surface, not here.
 */
