...
CREATE TABLE sessions (
  id ANY, version ANY, created_at ANY, cwd ANY, team_id ANY, participant_id ANY,
  parent_session ANY, seed_length ANY, origin ANY, delegation_depth ANY, agent_preset ANY,
