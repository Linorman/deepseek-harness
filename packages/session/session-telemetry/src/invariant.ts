/**
 * Package-owned invariant companion for `@clocky/clocky-session-telemetry`.
 * @module @clocky/clocky-session-telemetry/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-session-telemetry'
