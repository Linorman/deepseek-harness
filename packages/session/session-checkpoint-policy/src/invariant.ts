/**
 * Package-owned invariant companion for `@clocky/clocky-session-checkpoint-policy`.
 * @module @clocky/clocky-session-checkpoint-policy/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-session-checkpoint-policy'
