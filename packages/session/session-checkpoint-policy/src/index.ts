 ...
 * @module @clocky/clocky-session-checkpoint-policy
 */

import type { Context } from '@clocky/cordis'
import type { Session } from '@clocky/clocky-session'
import type { StreamChunk } from '@clocky/clocky-llm'
import { TOOL_ABORTED_BEFORE_DISPATCH, type ToolExecutionResult } from '@clocky/clocky-tools'
import type { PreStepDecision } from '@clocky/clocky-agent'
