/**
 * Package-owned invariant companion for `@clocky/clocky-session-projection-cache`.
 * @module @clocky/clocky-session-projection-cache/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-session-projection-cache'
