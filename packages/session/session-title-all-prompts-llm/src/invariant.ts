/**
 * Package-owned invariant companion for `@clocky/clocky-session-title-all-prompts-llm`.
 * @module @clocky/clocky-session-title-all-prompts-llm/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-session-title-all-prompts-llm'
