...
import type { ShellExecRequest, ShellExecSpec, ShellExecutor, ShellRunResult } from '@clocky/clocky-shell'
import { DEFAULT_HOOK_TIMEOUT_MS, runHook } from '@clocky/clocky-hook-protocol'
import type { RunHookOptions } from '@clocky/clocky-hook-protocol'
 ...
 * executor (clocky-bash-local) is exercised end-to-end by the hook-bridge plugins
...
function recordingBash(run: (spec: ShellExecSpec) => Promise<ShellRunResult>): {
  ...
  const bash = {
    resolve(request: ShellExecRequest): ShellExecSpec {
      ...
      // exactly what clocky-bash-local's resolve does for the fields runHook sets.
      return {
