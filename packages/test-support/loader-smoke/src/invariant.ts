/**
 * Package-owned invariant companion for `@clocky/clocky-loader-smoke`.
 * @module @clocky/clocky-loader-smoke/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-loader-smoke'
