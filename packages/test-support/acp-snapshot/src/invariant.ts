/**
 * Package-owned invariant companion for `@clocky/clocky-acp-snapshot`.
 * @module @clocky/clocky-acp-snapshot/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-acp-snapshot'
