/**
 * Package-owned invariant companion for `@clocky/clocky-agent-loop-testkit`.
 * @module @clocky/clocky-agent-loop-testkit/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-agent-loop-testkit'
