 ...
 *
 * The seam itself lives in `@clocky/clocky-compaction`, which re-exports these
 ...
 * `clocky-commands/brand` shape.
 *
 * @module @clocky/clocky-compaction/checkpoint
 */

import type { MessageSource } from '@clocky/clocky-llm/message'
