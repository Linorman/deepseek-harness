...
import * as commandCompact from '@clocky/clocky-command-compact'
...
describe('command-compact real Loader composition', () => {
  it('discovers and executes /compact through the assembled command plane', async () => {
    root = await mkdtemp(join(tmpdir(), 'clocky-command-compact-loader-'))
    ...
    const modules = new Map<string, unknown>([
      ...
      ['@clocky/clocky-command-compact', commandCompact],
    ])
