/**
 * Package-owned invariant companion for `@clocky/clocky-user-questions`.
 * @module @clocky/clocky-user-questions/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-user-questions'
