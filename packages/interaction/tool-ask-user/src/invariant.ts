/**
 * Package-owned invariant companion for `@clocky/clocky-tool-ask-user`.
 * @module @clocky/clocky-tool-ask-user/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-tool-ask-user'
