/**
 * clocky-commands' owned branded id: command lifecycle pairing across the
 * session log, the wire admission response, and client-side flow pairing.
 *
 * The `Branded<B>` primitive lives in `@clocky/clocky-brand`; this module
 ...
 * loading the host plugin's Context merges — the `clocky-llm/brand` shape.
 *
 * @module @clocky/clocky-commands/brand
 */
