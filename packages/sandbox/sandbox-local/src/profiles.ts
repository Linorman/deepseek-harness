 ...
 *
 * @module @clocky/clocky-sandbox-local/profiles
 */

import { grantArgs as landlockGrantArgs } from '@clocky/node-addon-landlock-run'
 ...
 * (`@clocky/clocky-fs-sandbox`) can never drift apart.
