/** Package-owned session-event invariants for sandbox policy. @module @clocky/clocky-sandbox-policy/invariant */
...
const PACKAGE_NAME = '@clocky/clocky-sandbox-policy'
