/**
 * Package-owned invariant companion for `@clocky/clocky-sandbox-windows-acl`.
 * @module @clocky/clocky-sandbox-windows-acl/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-sandbox-windows-acl'
