/**
 * `@clocky/clocky-web-fetch-http`: registers an anonymous public HTTP(S)
 ...
 *
 * @module @clocky/clocky-web-fetch-http
 */

import type { Context } from '@clocky/cordis'
import z from '@clocky/schemastery'
import type {} from '@clocky/clocky-web'
...
export const DEFAULT_USER_AGENT = 'agent-harness/0.0.1 (+https://example.invalid/agent-harness)'
