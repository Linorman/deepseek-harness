 ...
 * `@clocky/clocky-tool-web`. Requests carry no browser cookies or ambient credentials.
 *
 ...
 * @module @clocky/clocky-web-fetch-http/provider
 */

import { WebError } from '@clocky/clocky-web'
import type { WebFetchBody, WebFetchProvider, WebFetchRequest, WebFetchResult } from '@clocky/clocky-web'
