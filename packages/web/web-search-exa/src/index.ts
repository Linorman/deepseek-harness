/**
 * `@clocky/clocky-web-search-exa`: registers an Exa-backed `WebSearchProvider`
 ...
 * seam's provider registry. The key is owned by `@clocky/clocky-web`.
 *
 * @module @clocky/clocky-web-search-exa
 */
