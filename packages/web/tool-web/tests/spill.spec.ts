 ...
 * (`clocky-spill-local` backend + `clocky-spill-policy`), exercised through
...
import LocalSpillStore from '@clocky/clocky-spill-local'
...
beforeEach(async () => {
  ...
  spillRoot = mkdtempSync(join(tmpdir(), 'clocky-spill-web-'))
