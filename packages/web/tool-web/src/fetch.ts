...
import type { GenericCallView, JsonValue, ToolResult, WebFetchResultView } from '@clocky/clocky-tools'
import type { WebFetchBody, WebFetchResult } from '@clocky/clocky-web'
 ...
 * `@clocky/clocky-tool-call-timeout-policy`, not a model argument.
 *
 ...
 *   `ToolDefinition.timeoutMs` for `@clocky/clocky-tool-call-timeout-policy` to enforce.
