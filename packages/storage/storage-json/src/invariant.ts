/**
 * Package-owned invariant companion for `@clocky/clocky-storage-json`.
 * @module @clocky/clocky-storage-json/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-storage-json'
