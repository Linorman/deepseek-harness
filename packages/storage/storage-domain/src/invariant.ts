/**
 * Package-owned invariant companion for `@clocky/clocky-storage-domain`: every
 ...
 * @module @clocky/clocky-storage-domain/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-storage-domain'
