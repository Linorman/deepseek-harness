...
import * as GoalSessionInvariant from '@clocky/clocky-goal-round-driver/invariant'
import { renderGoalRoundPrompt } from '@clocky/clocky-goal-round-driver'
...
describe('goal-round-driver prompt invariants', () => {
  ...
  it('rejects a continuation whose content differs from the package renderer', async () => {
    ...
    expect(() => {
      ...
      code: 'INVARIANT',
      packageName: '@clocky/clocky-goal-round-driver',
    }))
  })
