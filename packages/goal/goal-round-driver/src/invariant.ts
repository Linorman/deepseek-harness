/** Package-owned goal-round prompt invariants. @module @clocky/clocky-goal-round-driver/invariant */

import { isDeepStrictEqual } from 'node:util'
import type { Context } from '@clocky/cordis'
import { foldGoal, type FoldedGoal, type GoalMessageSource, type GoalView } from '@clocky/clocky-goal'
...
const PACKAGE_NAME = '@clocky/clocky-goal-round-driver'
