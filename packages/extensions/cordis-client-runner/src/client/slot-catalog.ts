...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    hookContext: '',
    slotInject: '',
    declaredBy: 'an entry in \'team.workspace\' (client-ui-team), so it exists while that entry is mounted',
    occupants: [
      'client-ui-attachment ChannelMessage',
    ],
    replaceRisk: 'shadows-shipped-ui',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'team.channel.message\', () => ctx.slots.register(\n      { name: \'team.channel.message\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-team/src/client/index.ts:26',
  },
  {
    key: 'team.workspace',
    kind: 'single',
    scope: 'root',
    summary: 'Selected Team workspace, independent of the current Session.',
    doc: 'Selected Team workspace, independent of the current Session.',
    registerOptions: [],
    ownerProps: [],
    ownerPropsReferences: [],
    standardProps: [
