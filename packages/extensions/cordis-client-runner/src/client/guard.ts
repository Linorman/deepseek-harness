...
import type { DynamicCordisPackage } from '@clocky/clocky-api-remotes/client'
import type { SlotRegistry } from '@clocky/clocky-client-runtime/client'
import type { ThemeRuntime } from '@clocky/clocky-client-ui-theme/client'
      ...
      return (source: unknown, tokens: unknown): unknown => {
        ...
        if (tokens === undefined && typeof source === 'object' && source !== null) {
          return rejectGuard(env,
            ...
            + 'so pass any string first and the token map second: overrideTokens(\'mine\', { \'--clocky-alias-…\': { light: \'…\', dark: \'…\' } })',
          )
        }
