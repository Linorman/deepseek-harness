/**
 * Package-owned invariant companion for `@clocky/clocky-cordis-client-runner`.
 * @module @clocky/clocky-cordis-client-runner/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-cordis-client-runner'
