...
import { HOST_BUILTIN_INSPECTION } from '@clocky/clocky-cordis-host-runner'
import type { HostCordisInspectProviderRegistration } from '@clocky/clocky-cordis-host-runner'
