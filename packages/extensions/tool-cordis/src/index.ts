 ...
 * @module @clocky/clocky-tool-cordis
 */
...
} from '@clocky/clocky-cordis-host-runner'
import type { DynamicCordisReference } from '@clocky/clocky-cordis-host-runner'
...
function renderUnavailableReference(id: string): string {
  return [
    ...
    'It may have been removed, belong to another Session, or have been lost when the Clocky process restarted.',
