/**
 * Package-owned invariant companion for `@clocky/clocky-client-ui-cordis`.
 * @module @clocky/clocky-client-ui-cordis/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-client-ui-cordis'
