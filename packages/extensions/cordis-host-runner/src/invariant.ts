/**
 * Package-owned invariant companion for `@clocky/clocky-cordis-host-runner`.
 * @module @clocky/clocky-cordis-host-runner/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-cordis-host-runner'
