 ...
 * @module @clocky/clocky-cordis-host-runner/guard
 */

import { Context } from '@clocky/cordis'
import type { Plugin } from '@clocky/cordis'
import { scopeOf } from '@clocky/clocky-scope'
import { assertSupportedJsonSchema, defineTool } from '@clocky/clocky-tools'
...
function sandboxContext(ctx: Context, reportFailure: (error: Error) => void): Context {
  ...
  // (`@clocky/clocky-cordis-client-runner`, whose CTX_VERBS names this one its
