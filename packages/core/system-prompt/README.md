...
| Key | Default | Meaning |
|---|---|---|
| `includeHarnessIdentity` | `true` | Include the fixed `You are an AI agent running in a plugin-based harness.` order-−100 opener. Set false only when a deployment owns the complete system prompt. |
