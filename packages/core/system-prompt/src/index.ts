 ...
 *
 * @module @clocky/clocky-system-prompt
 */

import { Context, Service } from '@clocky/cordis'
import z from '@clocky/schemastery'
import { AnonymousEntries, NamedEntries, ScopedLayers, scopeTarget } from '@clocky/clocky-scope'
import type { ScopeKey, ScopeLayer, Scoped } from '@clocky/clocky-scope'
import type { ContextSnapshotSection, ToolSchema } from '@clocky/clocky-llm'
...
declare module '@clocky/cordis' {
  ...
  interface Events {
     ...
     * Scope-filtered dispatch (`@clocky/clocky-scope`): scoped listeners
  ...
  constructor(ctx: Context, config: Config) {
    ...
    if (config.includeHarnessIdentity ?? true) {
      this.section({
        ...
        order: -100,
        text: 'You are an AI agent running in a plugin-based harness.',
      })
    }
    this.section({
