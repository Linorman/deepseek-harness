 ...
 * whose JSON envelopes dwarf their payloads (~56× measured on a real provider
 ...
 *
 * @module @clocky/clocky-session/chunk-rows
 */

import { CallId, assertNever } from '@clocky/clocky-llm'
