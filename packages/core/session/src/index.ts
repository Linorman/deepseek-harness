 ...
 *
 * @module @clocky/clocky-session
 */

import { Context, Service } from '@clocky/cordis'
import { isAbsolute } from 'node:path'
import { deepFreeze } from '@clocky/clocky-llm'
import { scopeOf, scopeTarget } from '@clocky/clocky-scope'
import type { Scoped } from '@clocky/clocky-scope'
import type { Message } from '@clocky/clocky-llm'
import { SESSION_FORMAT_VERSION, SessionId } from './types.ts'
import type { TypertLookup } from '@clocky/clocky-typert-protocol'
...
export type { AssistantMessage, ToolResultMessage, UserMessage } from '@clocky/clocky-llm'
  ...
  constructor(ctx: Context) {
    ...
    ctx.inject(['typert'], (typeCtx) => {
      typeCtx.typert.lookups.register('session', {
        parameter: 'session',
        wire: 'sessionId',
        hostTypeSymbol: '@clocky/clocky-session#Session',
        wireTypeSymbol: '@clocky/clocky-session/types#SessionId',
