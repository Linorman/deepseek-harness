/**
 * Package-owned invariant companion for `@clocky/clocky-agent-tool-presentation`.
 * @module @clocky/clocky-agent-tool-presentation/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-agent-tool-presentation'
 ...
 * registry's to hold, and `clocky-tools` observes it there.
 */
