 ...
 * ([`clocky-code-runtime-worker-thread`](../../code-runtime/code-runtime-worker/README.md)).
 ...
 * @module @clocky/clocky-agent-tool-presentation
 */

import type { Context } from '@clocky/cordis'
import z from '@clocky/schemastery'
import type { ToolPresentationMode } from '@clocky/clocky-tools'
...
export function apply(ctx: Context, config: Config): void {
  ...
  // what `clocky-agent-presets` reports as an unusable row, naming this id.
