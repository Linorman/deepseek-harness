...
import { createUserMessage, CallId, HarnessError, type ContentBlock  } from '@clocky/clocky-llm'
import SystemPrompt from '@clocky/clocky-system-prompt'
import type { Agent } from '@clocky/clocky-agent'
import ApprovalService, { type ApprovalOutcome, type ApprovalRequest } from '@clocky/clocky-user-approval'
import ToolRuntime, {
...
describe('ToolRuntime', () => {
  ...
  it('ToolNotFoundError carries a stable message and code', async () => {
    const { HarnessError } = await import('@clocky/clocky-llm')
