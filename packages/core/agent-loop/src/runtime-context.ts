 ...
 * @module @clocky/clocky-agent-loop/runtime-context
 */

import { createUserMessage } from '@clocky/clocky-llm'
import type { ContextSnapshotSection } from '@clocky/clocky-llm'
import type { Session, UserMessage } from '@clocky/clocky-session'
import { isReplacementSurfaceEvent } from '@clocky/clocky-session'
import type { Context } from '@clocky/cordis'

const SOURCE = '@clocky/clocky-system-prompt'
