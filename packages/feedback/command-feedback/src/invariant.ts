/**
 * Package-owned invariant companion for `@clocky/clocky-command-feedback`.
 * @module @clocky/clocky-command-feedback/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-command-feedback'
