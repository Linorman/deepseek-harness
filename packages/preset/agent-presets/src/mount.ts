 ...
 * @module @clocky/clocky-agent-presets/mount
 */
...
import type { EntryTree } from '@clocky/cordis-plugin-loader'
import { scopeOf, scopeParentOf, type ScopeKey } from '@clocky/clocky-scope'
...
class PresetTree extends Include {
   ...
   * dependencies, so every `@clocky/clocky-*` row would fail to import. The
 ...
 * invariant companion's service listener, and `clocky-invariants` is a
