 ...
 * @module @clocky/clocky-agent-presets/discovery
 */
...
import { expandHomePath } from '@clocky/clocky-home-paths'
 ...
 *
 * This package owns the writable root the way `clocky-skill-filesystem` owns
 * `<clockyHome>/skills`. An app must assemble the SHIPPED root, whose path only
