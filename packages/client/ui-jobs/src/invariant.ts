/**
 * Package-owned invariant companion for `@clocky/clocky-client-ui-jobs`.
 * @module @clocky/clocky-client-ui-jobs/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-client-ui-jobs'
