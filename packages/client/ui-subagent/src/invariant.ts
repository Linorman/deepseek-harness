/**
 * Package-owned invariant companion for `@clocky/clocky-client-ui-subagent`.
 * @module @clocky/clocky-client-ui-subagent/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-client-ui-subagent'
