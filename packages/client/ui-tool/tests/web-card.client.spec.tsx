...
import type { ToolResultView } from '@clocky/clocky-api-remotes/client'
import { bindSnapshotSelector } from '@clocky/clocky-client-test-runtime'
import type { SelectionTarget } from '@clocky/clocky-client-ui-conversation/client'
import type { ToolCallOwnerProps } from '@clocky/clocky-client-ui-tool/client'
import { IconGlobeOutline14 } from '@clocky/clocky-client-ui-primitives'
...
import { DetailsPanel } from '@clocky/clocky-client-ui-conversation/src/client/skeleton/DetailsPanel.tsx'
...
import { zh } from '@clocky/clocky-client-ui-conversation/src/client/locales.ts'
...
const SEARCH_ARGS = '{"query":"agent harness"}'
...
describe('web toolview registration', () => {
  it('registers one WebRow under both web_search and web_fetch', () => {
    ...
    } as unknown as import('@clocky/cordis').Context
