...
import type { HostDescription } from '@clocky/clocky-client-connection/client'
import type {
  ChatConversationViewNode, ChatSnapshot, ConversationNode, RunningToolCall, SessionId,
} from '@clocky/clocky-client-runtime/client'
import type { SessionProviderComponent, TranslateNS } from '@clocky/clocky-client-ui-slots'
import type { DetailsSlotProps, DetailsToolOwnerProps } from '@clocky/clocky-client-ui-conversation/src/client/contract/slots.ts'
