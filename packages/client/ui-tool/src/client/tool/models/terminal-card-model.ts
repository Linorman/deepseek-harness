 ...
 * @module
 */
import { resolveWorkspacePath } from '@clocky/clocky-client-runtime/client'
import type { TerminalBlockLabels, TerminalBlockProps } from '@clocky/clocky-client-ui-primitives'
 ...
 * `ToolResultNode.call`/`callView` in clocky-client-runtime), leaving a terminal
