/**
 * Package-owned invariant companion for `@clocky/clocky-client-ui-tool`.
 * @module @clocky/clocky-client-ui-tool/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-client-ui-tool'
