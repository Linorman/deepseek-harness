...
import type { LocaleSettings, LocaleSnapshot } from '@clocky/clocky-client-locale/client'
import { FALLBACK_LOCALE, LocaleRuntime } from '@clocky/clocky-client-locale/client'
 ...
 * `usePinnedBrowserLanguages` (clocky-client-test-runtime): they need the shapes
...
describe('LocaleRuntime', () => {
  ...
  it('persists an explicit pick of the provisional locale, so a shared Clocky home agrees', () => {
