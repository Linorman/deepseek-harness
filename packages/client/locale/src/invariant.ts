/**
 * Package-owned invariant companion for `@clocky/clocky-client-locale`.
 * @module @clocky/clocky-client-locale/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-client-locale'
