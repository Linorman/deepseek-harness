 ...
 * @module @clocky/clocky-client-ui-message-feedback/client/controller
 */

import type { RemoteResult } from '@clocky/clocky-typert-protocol'
import type { HostObservable } from '@clocky/clocky-client-ui-slots'
import type { MessageId, SessionId } from '@clocky/clocky-client-connection/client'
import type {
...
} from '@clocky/clocky-message-feedback/types'
