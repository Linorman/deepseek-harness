/**
 * Package-owned invariant companion for `@clocky/clocky-client-ui-message-feedback`.
 * @module @clocky/clocky-client-ui-message-feedback/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-client-ui-message-feedback'
