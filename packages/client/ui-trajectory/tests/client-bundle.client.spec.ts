 ...
 * not built (`pnpm --filter @clocky/clocky-client-ui-trajectory bundle`).
 */
...
const PLUGIN_ID = '@clocky/clocky-client-ui-trajectory'
...
describe('tsdown client artifact', () => {
  ...
  async function loadArtifact() {
    ...
    const modules = new Map<string, unknown>([
      ...
      ['@clocky/clocky-client-runtime/client', await import('@clocky/clocky-client-runtime/client')],
      ['@clocky/clocky-client-ui-primitives', await import('@clocky/clocky-client-ui-primitives')],
    ])
  ...
  it.skipIf(code === undefined)('mounted as an object plugin, apply registers the view tab on the real ring', async () => {
    ...
    const locale = await import('@clocky/clocky-client-locale/client')
