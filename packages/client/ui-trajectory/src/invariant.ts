/**
 * Package-owned invariant companion for `@clocky/clocky-client-ui-trajectory`.
 * @module @clocky/clocky-client-ui-trajectory/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-client-ui-trajectory'
