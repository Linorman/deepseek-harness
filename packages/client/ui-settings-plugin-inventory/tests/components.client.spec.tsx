...
const SNAPSHOT = {
  entries: [
    { entryId: '8a1b2c3d', moduleName: '@clocky/cordis-plugin-hmr', enabled: true, fiberPhase: 'active' },
    ...
    { entryId: 'disabled-entry', moduleName: '@clocky/clocky-host-directory-picker-native', enabled: false, fiberPhase: null },
  ],
