/**
 * Package-owned invariant companion for `@clocky/clocky-client-ui-reference`.
 * @module @clocky/clocky-client-ui-reference/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-client-ui-reference'
