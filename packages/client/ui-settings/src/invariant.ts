/**
 * Package-owned invariant companion for `@clocky/clocky-client-ui-settings`.
 * @module @clocky/clocky-client-ui-settings/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-client-ui-settings'
