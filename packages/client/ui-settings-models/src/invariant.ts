/**
 * Package-owned invariant companion for `@clocky/clocky-client-ui-settings-models`.
 * @module @clocky/clocky-client-ui-settings-models/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-client-ui-settings-models'
