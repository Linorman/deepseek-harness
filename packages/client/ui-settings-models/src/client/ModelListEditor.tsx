...
import type { DiscoveredModelView, IApiClient } from '@clocky/clocky-api-remotes/client'
import { Button, Modal } from '@clocky/clocky-client-ui-primitives'
import { formatCapacity, parseCapacity } from './model-utils.ts'
import type { ModelDraft } from './model-utils.ts'
import { messageOf } from './store.ts'
import type { en } from './locales.ts'
import styles from './ModelsSection.module.css'

/**
 * One configured model row. Structurally open: a profile field this card does not edit — one a future
 ...
 * {@link formatCapacity}, so the settings card reads and writes one K/M vocabulary.
