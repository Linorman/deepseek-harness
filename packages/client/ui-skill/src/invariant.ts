/**
 * Package-owned invariant companion for `@clocky/clocky-client-ui-skill`.
 * @module @clocky/clocky-client-ui-skill/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-client-ui-skill'
