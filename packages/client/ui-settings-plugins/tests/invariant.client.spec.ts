...
import * as PluginConfigInvariant from '@clocky/clocky-client-ui-settings-plugins/invariant'
...
describe('invariant companion', () => {
  ...
  it('has an empty node half', async () => {
    const { apply } = await import('@clocky/clocky-client-ui-settings-plugins')
