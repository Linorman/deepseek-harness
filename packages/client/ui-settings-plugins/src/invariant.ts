/**
 * Package-owned invariant companion for `@clocky/clocky-client-ui-settings-plugins`.
 * @module @clocky/clocky-client-ui-settings-plugins/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-client-ui-settings-plugins'
