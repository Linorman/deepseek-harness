/**
 * Package-owned invariant companion for `@clocky/clocky-client-ui-slots`.
 * @module @clocky/clocky-client-ui-slots/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-client-ui-slots'
