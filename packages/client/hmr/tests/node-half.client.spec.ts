...
import type { WebBootGraph, ClientModuleRegistry } from '@clocky/clocky-client-modules'
import type { WebRoute, WebServer } from '@clocky/clocky-host-webserver'
...
beforeEach(() => { dir = mkdtempSync(join(tmpdir(), 'clocky-hmr-')) })
