/**
 * Package-owned invariant companion for `@clocky/clocky-client-ui-goal`.
 * @module @clocky/clocky-client-ui-goal/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-client-ui-goal'
