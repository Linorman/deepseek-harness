...
import type { GoalSnapshot } from '@clocky/clocky-goal/client'
import {
...
export type GoalDockProps = import('@clocky/clocky-client-ui-slots').PropsRuntime<'conversation.input.dock'> & GoalBarActions & PropsLocale<'goal'>
