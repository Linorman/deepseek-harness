...
import { SlotRegistry, type SessionId } from '@clocky/clocky-client-runtime/client'
import { ConversationEventRegistry } from '@clocky/clocky-client-runtime/src/client/conversation/event-registry.ts'
import type { GoalProjection } from '@clocky/clocky-goal/client'
