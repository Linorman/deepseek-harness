/**
 * Package-owned invariant companion for `@clocky/clocky-client-ui-directory-picker-native`.
 * @module @clocky/clocky-client-ui-directory-picker-native/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-client-ui-directory-picker-native'
