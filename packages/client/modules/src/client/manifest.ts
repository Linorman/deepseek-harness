 ...
 * `__CLOCKY_BOOT__` wire types, the boot-manifest parser, and the boundaries around
 * {@link ClientModuleSystem}. The package root is the host-side service that
 * composes the wire.
 */

import type {} from '@clocky/cordis'
...
/**
 * Validate an optional string-array field read from a `clocky.client` declaration
...
export function parseBootManifest(wire: unknown): BootManifest {
  if (typeof wire !== 'object' || wire === null) {
    throw new Error('client-modules: window.__CLOCKY_BOOT__ is missing or not an object')
  }
