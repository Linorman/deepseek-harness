...
export const zh = {
  ...
  'message.maxTokens.continue': '继续输出',
  'message.maxTokens.draftBusy': '请先发送或清除当前草稿，再继续输出。',
...
export const en = {
  ...
  'placeholder.task': 'Start a new task from the sidebar',
  ...
  'message.maxTokens.continue': 'Continue output',
  'message.maxTokens.draftBusy': 'Send or clear the current draft before continuing the output.',
