// Hero chrome for the blank-draft phase of ConversationRoot: neutral mark headline,
...
import {
  BrandPlaceholderMark, IconChevronDownOutline14, IconFolderClose16, IconFolderOpen16,
} from '@clocky/clocky-client-ui-primitives'
import { workspaceTitleOf } from '@clocky/clocky-client-runtime/client'
    ...
    <div className={css.root}>
      <div className={css.stack}>
        <div className={css.headline}>
          {/* A 34px neutral mark leads the headline and preserves the brand slot. */}
          <span className={css.markHitbox}>
            {renderSlot('conversation.hero.brand.mark', { size: 34, className: css.mark }, {
              fallback: <BrandPlaceholderMark size={34} className={css.mark} />,
            })}
          </span>
