// Hero chrome for the blank-draft phase of ConversationRoot: neutral mark
// headline and glow backdrop. Pure presentation — the resident
...
import { BrandPlaceholderMark } from '@clocky/clocky-client-ui-primitives'
...
/**
 * Render the hero chrome (headline only; no glow or composer — the glow is
 * the owner's {@link HeroGlow}).
    ...
    <div className={css.root}>
      <div className={css.stack}>
        ...
        <div className={css.body}>
          {/* The resident composer is CSS-centered in this scroll body during hero. */}
        </div>
      </div>
      {children}
    </div>
