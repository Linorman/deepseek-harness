/**
 * Package-owned invariant companion for `@clocky/clocky-client-ui-theme`.
 * @module @clocky/clocky-client-ui-theme/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-client-ui-theme'
