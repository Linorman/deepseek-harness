/**
 * Package-owned invariant companion for `@clocky/clocky-client-runtime`.
 * @module @clocky/clocky-client-runtime/invariant
 */
...
import type { SlotMap } from '@clocky/clocky-client-ui-slots'
import type { InvariantInstaller } from '@clocky/clocky-invariants'

const PACKAGE_NAME = '@clocky/clocky-client-runtime'
