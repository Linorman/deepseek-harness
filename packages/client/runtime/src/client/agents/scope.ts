 ...
 * Agent's identity. The mechanism mirrors the host `clocky-scope` architecture
...
import type { TypertClientRemote, TypertRemoteScopeApi } from '@clocky/clocky-typert-protocol'
...
const kScope = Symbol('clocky.client.scope')
