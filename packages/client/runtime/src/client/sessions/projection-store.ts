...
// (`/types`, zero imports), never the package root: the root's clocky-agent →
// clocky-session chain would drag the host `Context.sessions` merge into the
...
export type { SessionProjectionMap } from '@clocky/clocky-session-projection/types'
