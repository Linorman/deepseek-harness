# @clocky/clocky-client-ui-attachment
...
- **Images only** — non-image files have no rail card or history renderer yet; file cards and upload-progress states wait until the composer accepts non-image attachments.
