 ...
 * (the chat drag mask). Decoration only: `pointer-events: none` keeps
...
/** Tilted photo-and-note cards for the upload illustration. */
const UploadIllustration = () => (
  <svg width="115" height="84" viewBox="0 0 115 84" fill="none" xmlns="http://www.w3.org/2000/svg">
    <g clipPath="url(#clockyDropOverlayClip)">
    ...
    <defs>
      <clipPath id="clockyDropOverlayClip">
...
/** Greyed cards with a blocked badge for a disabled illustration. */
