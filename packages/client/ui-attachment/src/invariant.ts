/**
 * Package-owned invariant companion for `@clocky/clocky-client-ui-attachment`.
 * @module @clocky/clocky-client-ui-attachment/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-client-ui-attachment'
