...
export const en: Record<AgentPresetSettingsKey, string> = {
  ...
  presetStandardDescription:
    'Full coding agent with file editing, shell, file and web search, skills, planning, goals, and Team coordination.',
...
export const zh: Record<AgentPresetSettingsKey, string> = {
  ...
  presetStandardDescription: '功能完整的编码 Agent，支持文件编辑、Shell、文件与网页检索、Skills、计划、目标和 Team 协作。',
