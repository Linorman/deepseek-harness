/**
 * Package-owned invariant companion for `@clocky/clocky-client-ui-agent-preset`.
 * @module @clocky/clocky-client-ui-agent-preset/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-client-ui-agent-preset'
