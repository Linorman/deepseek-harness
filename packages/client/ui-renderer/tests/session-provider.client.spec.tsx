...
import type { SessionMaybeProvideInfo, StoredEntry } from '@clocky/clocky-client-ui-slots'
import type { SessionProvideInfo, SlotRendererHost } from '@clocky/clocky-client-ui-renderer/client'
