...
import { TestSessions, TestWorkspaces } from '@clocky/clocky-client-test-runtime'
import type { Stabilizer } from '@clocky/clocky-client-test-runtime'
import { apply as nodeApply } from '@clocky/clocky-client-ui-renderer'
...
describe('UI renderer plugin', () => {
  ...
  it('hydrates the boot page before switching to the assembled application', async () => {
    ...
    slots.register({ name: 'root' }, () => <div data-testid="root-probe" />)
    const el = container()
    el.innerHTML = '<div class="boot" data-clocky-boot=""><div><div class="spinner" data-clocky-boot-spinner="" style="--clocky-boot-arc: 180deg"></div><div>Loading plugins…</div></div></div>'
