  ...
  if (cache === undefined) {
    cache = {
      root: {
        ...
        ...host.teamTasks === undefined ? {} : { useTeamTasks: observableHook(host.teamTasks.list) },
      },
      session: new WeakMap(),
 ...
 * useSessions/useWorkspaces/useTeamTasks hooks, the per-session provide bundle (every
