/**
 * Package-owned invariant companion for `@clocky/clocky-client-ui-renderer`.
 * @module @clocky/clocky-client-ui-renderer/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-client-ui-renderer'
