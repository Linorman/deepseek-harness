/**
 * Package-owned invariant companion for `@clocky/clocky-client-ui-model-selection`.
 * @module @clocky/clocky-client-ui-model-selection/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-client-ui-model-selection'
