# @clocky/clocky-client-ui-permission-presets
...
The current-session decoration and composer access chip are omitted for Team-owned coordinator Sessions. The generic Session command path is fenced there; Team permission control needs an authenticated Team operation before it can be exposed.
