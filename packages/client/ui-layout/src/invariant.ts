/**
 * Package-owned invariant companion for `@clocky/clocky-client-ui-layout`.
 * @module @clocky/clocky-client-ui-layout/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-client-ui-layout'
