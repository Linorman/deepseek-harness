/**
 * Package-owned invariant companion for `@clocky/clocky-client-ui-settings-general`.
 * @module @clocky/clocky-client-ui-settings-general/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-client-ui-settings-general'
