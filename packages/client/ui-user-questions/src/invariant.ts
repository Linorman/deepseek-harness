/**
 * Package-owned invariant companion for `@clocky/clocky-client-ui-user-questions`.
 * @module @clocky/clocky-client-ui-user-questions/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-client-ui-user-questions'
