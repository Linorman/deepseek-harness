/**
 * Package-owned invariant companion for `@clocky/clocky-client-ui-sidebar`.
 * @module @clocky/clocky-client-ui-sidebar/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-client-ui-sidebar'
