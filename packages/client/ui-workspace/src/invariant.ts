/**
 * Package-owned invariant companion for `@clocky/clocky-client-ui-workspace`.
 * @module @clocky/clocky-client-ui-workspace/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-client-ui-workspace'
