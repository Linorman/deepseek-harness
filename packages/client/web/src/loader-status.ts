 ...
 * @module @clocky/clocky-client-web/src/loader-status
 */
import type { FiberState } from '@clocky/cordis'
 ...
 * while retaining its type (same rationale as clocky-tool-cordis's mirror).
 */
