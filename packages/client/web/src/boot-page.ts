 ...
 * @module @clocky/clocky-client-web/src/boot-page
 */
...
export class BootPage {
  ...
  constructor(container: HTMLElement) {
    ...
    this.root.dataset.clockyBoot = ''
    this.card = div(css.card)
    this.wordmark = div(css.wordmark, 'CLOCKY')
    this.spinner = div(css.spinner)
    this.spinner.dataset.clockyBootSpinner = ''
  ...
  private updateProgress(): void {
    ...
    this.spinner.style.setProperty('--clocky-boot-arc', `${String(Math.round(72 + ratio * 216))}deg`)
  }
}
