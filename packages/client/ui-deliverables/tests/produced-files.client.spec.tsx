...
import { apply as applyLocale, inject as localeInject } from '@clocky/clocky-client-locale/client'
import type { ChatFileMentions, TurnTailOwnerProps } from '@clocky/clocky-client-ui-conversation/client'
import { makeTranslate, stubSettingsScope } from '@clocky/clocky-client-test-runtime'
import {
...
describe('package shells', () => {
  it('the invariant companion registers ownership', async () => {
    ...
    expect(registered).toEqual(['@clocky/clocky-client-ui-deliverables'])
