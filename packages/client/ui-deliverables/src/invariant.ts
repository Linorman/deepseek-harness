/**
 * Package-owned invariant companion for `@clocky/clocky-client-ui-deliverables`.
 * @module @clocky/clocky-client-ui-deliverables/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-client-ui-deliverables'
