/**
 * Package-owned invariant companion for `@clocky/clocky-client-ui-input-trigger`.
 * @module @clocky/clocky-client-ui-input-trigger/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-client-ui-input-trigger'
