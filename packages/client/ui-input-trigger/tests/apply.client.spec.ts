...
import { createScope, scopeOf, SlotRegistry } from '@clocky/clocky-client-runtime/client'
import type { SessionId } from '@clocky/clocky-client-runtime/client'
import { apply, inject, InputTriggerService } from '@clocky/clocky-client-ui-input-trigger/client'
import type { MenuViewInjected } from '@clocky/clocky-client-ui-input-trigger/client'
