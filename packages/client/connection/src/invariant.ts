/**
 * Package-owned invariant companion for `@clocky/clocky-client-connection`.
 * @module @clocky/clocky-client-connection/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-client-connection'
