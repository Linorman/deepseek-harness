/**
 * Package-owned invariant companion for `@clocky/clocky-client-ui-primitives`.
 * @module @clocky/clocky-client-ui-primitives/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-client-ui-primitives'
