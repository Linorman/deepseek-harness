/**
 * Package-owned invariant companion for `@clocky/clocky-agent-spine-demo`.
 * @module @clocky/clocky-agent-spine-demo/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-agent-spine-demo'
