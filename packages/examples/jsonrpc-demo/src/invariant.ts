/**
 * Package-owned invariant companion for `@clocky/clocky-sdk-jsonrpc-demo`.
 * @module @clocky/clocky-sdk-jsonrpc-demo/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-sdk-jsonrpc-demo'
