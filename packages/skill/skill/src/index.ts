 ...
 * Concrete
 * providers such as `@clocky/clocky-skill-filesystem` decide where skills come
 ...
 *
 * @module @clocky/clocky-skill
 */

import { Context, Service } from '@clocky/cordis'
import { assertNever } from '@clocky/clocky-llm'
import { NamedEntries, ScopedLayers, scopeChainOf, scopeOf } from '@clocky/clocky-scope'
import type { ScopeKey, ScopeLayer } from '@clocky/clocky-scope'
...
export type SkillSource = 'project-clocky' | 'project-agents' | 'runtime' | 'user-clocky' | 'user-agents' | 'custom' | 'bundled' | (string & {})
