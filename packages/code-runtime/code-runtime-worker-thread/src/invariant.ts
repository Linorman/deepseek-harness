/**
 * Package-owned invariant companion for `@clocky/clocky-code-runtime-worker-thread`.
 * @module @clocky/clocky-code-runtime-worker-thread/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-code-runtime-worker-thread'
