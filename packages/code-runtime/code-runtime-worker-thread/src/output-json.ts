/** JSON string-prefix accounting for the outer-output ledger. @module @clocky/clocky-code-runtime-worker-thread/output-json */

import type { CodeJsonValue } from '@clocky/clocky-code-runtime'
