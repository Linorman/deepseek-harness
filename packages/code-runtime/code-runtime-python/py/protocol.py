"""Wire protocol vocabulary for the Python side of clocky-code-runtime-python.
...
def log_truncation_marker(max_bytes: int) -> str:
    ...
    return f"[clocky-code-runtime-python] log capture truncated at {max_bytes} bytes"
