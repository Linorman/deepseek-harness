 ...
 * @module @clocky/clocky-code-runtime
 */
 ...
 * `__clocky_main__`/`__builtins__`/`__name__` (the Python backend's bootstrap
...
export const RESERVED_BINDING_GLOBALS: ReadonlySet<string> = new Set([
  'console',
  '__clocky_main__', '__builtins__', '__name__', '__debug__',
])
...
export abstract class CodeRuntime extends Service {
   ...
   * `clocky-tools` presents; only `'typescript'` has a published backend.
   */
