/**
 * Package-owned invariant companion for `@clocky/clocky-jobs-local`.
 * @module @clocky/clocky-jobs-local/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-jobs-local'
...
/**
 * No runtime invariant: `@clocky/clocky-jobs/invariant` owns per-snapshot identity, status,
