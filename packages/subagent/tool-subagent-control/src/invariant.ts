/**
 * Package-owned invariant companion for `@clocky/clocky-tool-subagent-control`.
 * @module @clocky/clocky-tool-subagent-control/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-tool-subagent-control'
