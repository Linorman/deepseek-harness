/**
 * Package-owned invariant companion for `@clocky/clocky-tool-subagent-report`.
 * @module @clocky/clocky-tool-subagent-report/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-tool-subagent-report'
