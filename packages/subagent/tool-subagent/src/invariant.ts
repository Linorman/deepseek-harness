/**
 * Package-owned invariant companion for `@clocky/clocky-tool-subagent`.
 * @module @clocky/clocky-tool-subagent/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-tool-subagent'
