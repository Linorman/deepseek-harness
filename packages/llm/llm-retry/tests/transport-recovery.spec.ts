...
import type { MockLlmBehavior, MockLlmServer } from '@clocky/clocky-llm-mock-server'
...
async function harness(
  ...
  vi.stubEnv('TEST_API_KEY', 'mock-key')
...
describe('bounded retry through the real provider HTTP/SSE adapter', () => {
