 ...
 *
 * @module clocky-llm-pi-ai/discovery
 */

import { INVALID_CREDENTIAL_CODE, LlmError, normalizeApiKey } from '@clocky/clocky-llm'
import type { LlmDiscoveredModel, LlmModelDiscoveryRequest } from '@clocky/clocky-llm'
import { attributionHeaders } from '@clocky/clocky-llm'
 ...
 * on the length the server claims — the same two-stage shape `clocky-web-fetch`
