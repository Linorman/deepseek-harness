 ...
 *
 * @module clocky-llm-pi-ai/replay
 */

import { LlmError } from '@clocky/clocky-llm'
import type { Message, ModelMessageSource, ReplayEnvelope } from '@clocky/clocky-llm'
...
function foreignAssistant(message: Message): AssistantMessage {
  ...
  return {
    ...
    api: 'clocky-foreign',
    provider: source?.provider ?? 'clocky-foreign',
    model: source?.model ?? 'clocky-foreign',
    usage: emptyPiUsage(),
