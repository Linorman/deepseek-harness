...
import LlmRuntime, { createUserMessage, CallId } from '@clocky/clocky-llm'
import type { Message, ToolSchema } from '@clocky/clocky-llm'
...
const openAIBaseURL = process.env.CLOCKY_PI_AI_OPENAI_BASE_URL
...
const anthropicBaseURL = process.env.CLOCKY_PI_AI_ANTHROPIC_BASE_URL

const providerCases: ProviderCase[] = [
  {
    provider: 'openai',
    api: 'openai-responses',
    model: process.env.CLOCKY_PI_AI_OPENAI_MODEL ?? 'gpt-5.5',
    ...azureOpenAIKey
  ...
  },
  {
    ...
    model: process.env.CLOCKY_PI_AI_ANTHROPIC_MODEL ?? 'claude-opus-4-8',
