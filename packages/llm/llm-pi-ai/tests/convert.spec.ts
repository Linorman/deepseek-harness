...
import { AttachmentId, ImageVariantId } from '@clocky/clocky-attachment'
import type { AttachmentStore, ImageAttachmentRef, ImageRequestPolicy, RequestImageAttachment } from '@clocky/clocky-attachment'
import { createUserMessage, CallId, CONTEXT_WINDOW_EXCEEDED_CODE, EMPTY_RESPONSE_CODE, createMessage } from '@clocky/clocky-llm'
import type { ContentBlock, StreamChunk } from '@clocky/clocky-llm'
...
describe('toPiContext', () => {
  ...
  it('degrades the flat pre-envelope replay state a legacy session log carries', () => {
    ...
    expect(context.messages[0]).toMatchObject({ role: 'assistant', api: 'clocky-foreign' })
