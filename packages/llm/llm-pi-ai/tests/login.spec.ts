...
import AuthorizationService from '@clocky/clocky-authorization'
import type { AuthorizationInteraction, AuthorizationNotice, AuthorizationPrompt } from '@clocky/clocky-authorization'
import LocalCredentialProvider from '@clocky/clocky-credentials-local'
import type { CredentialKey } from '@clocky/clocky-credentials'
...
async function harness(): Promise<Context> {
  const dir = await mkdtemp(join(tmpdir(), 'clocky-pi-login-'))
  dirs.push(dir)
