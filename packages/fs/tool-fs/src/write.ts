 ...
 * @module @clocky/clocky-tool-fs/src/write
 */

import type { Context } from '@clocky/cordis'
import { defineTool } from '@clocky/clocky-tools'
import type { DiffCallView, DiffResultView, ToolResult } from '@clocky/clocky-tools'
import type { FsWriteOutcome } from '@clocky/clocky-fs'
