 ...
 * @module @clocky/clocky-tool-fs/src/read-image
 */

import { basename, extname } from 'node:path'
import type { Context } from '@clocky/cordis'
import { AttachmentError, AttachmentId } from '@clocky/clocky-attachment'
...
import type { GenericCallView, ToolExecution } from '@clocky/clocky-tools'
import type {} from '@clocky/clocky-fs'
