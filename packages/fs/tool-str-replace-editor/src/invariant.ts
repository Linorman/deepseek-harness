/**
 * Package-owned invariant companion for `@clocky/clocky-tool-str-replace-editor`.
 * @module @clocky/clocky-tool-str-replace-editor/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-tool-str-replace-editor'
