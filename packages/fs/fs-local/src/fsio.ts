 ...
 * streams large files, and rejects binary data; line windows belong to `clocky-tool-fs`. Writes
 * stage an exclusive owner-only file in a private sibling directory and atomically publish it.
 * @module @clocky/clocky-fs-local/fsio
 */
...
import { FsError, FsTargetKey, FsVersion } from '@clocky/clocky-fs'
