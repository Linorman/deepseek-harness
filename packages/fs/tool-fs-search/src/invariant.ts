/**
 * Package-owned invariant companion for `@clocky/clocky-tool-fs-search`.
 * @module @clocky/clocky-tool-fs-search/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-tool-fs-search'
