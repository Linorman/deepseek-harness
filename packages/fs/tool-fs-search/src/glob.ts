 ...
 * @module @clocky/clocky-tool-fs-search/glob
 */

import type { Context } from '@clocky/cordis'
import { sep } from 'node:path'
import { defineTool } from '@clocky/clocky-tools'
import type { GenericCallView, SearchResultView, ToolResult } from '@clocky/clocky-tools'
import type { SpillRef } from '@clocky/clocky-spill'
