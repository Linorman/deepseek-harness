/** Shared top-level-call post-policy selection for search result spill. @module clocky-tool-fs-search/direct-call */

import type { Context } from '@clocky/cordis'
import type { JsonValue, PostToolDecision, ToolDefinition, ToolExecution, ToolExecutionResult } from '@clocky/clocky-tools'
