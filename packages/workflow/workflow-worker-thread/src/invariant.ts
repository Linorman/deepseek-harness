/**
 * Package-owned invariant companion for `@clocky/clocky-workflow-worker-thread`.
 * @module @clocky/clocky-workflow-worker-thread/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-workflow-worker-thread'
