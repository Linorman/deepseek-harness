...
const ALPHA = credentialRef('CLOCKY_REVIEW_ALPHA')
const BETA = credentialRef('CLOCKY_REVIEW_BETA')
const INNER = credentialRef('CLOCKY_REVIEW_INNER')
...
async function tempDir(): Promise<string> {
  const dir = await mkdtemp(join(tmpdir(), 'clocky-cred-review-'))
