...
const KEY = credentialRef('CLOCKY_CRED_PIPE')
...
async function tempDir(): Promise<string> {
  const dir = await mkdtemp(join(tmpdir(), 'clocky-credentials-watch-'))
