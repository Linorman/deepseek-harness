...
import { AuthorizationDeclinedError, type AuthorizationSession } from '@clocky/clocky-authorization'
import { credentialKey } from '@clocky/clocky-credentials'
