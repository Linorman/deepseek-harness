/**
 * End-to-end tests for clocky-mcp-client. Exercises the REAL MCP protocol against:
...
import { apply } from '@clocky/clocky-mcp-client/src/index.ts'
import { publicToolName } from '@clocky/clocky-mcp-client/src/tools.ts'
import type { Config } from '@clocky/clocky-mcp-client'
...
async function mountImageRegistry(clockyHome: string): Promise<Context> {
  const ctx = await mountRegistry()
  await ctx.plugin(LocalAttachmentStore, { clockyHome })
