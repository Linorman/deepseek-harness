/**
 * Real-load-path guard for @clocky/clocky-mcp-client. `mcp-client` is a
...
import * as mcpClient from '@clocky/clocky-mcp-client'

describe('clocky-mcp-client real-load-path guard', () => {
