 ...
 * is `mcp__<serverName>__<rawName>`, normalized to the model function-name
...
import { isImageAdmissionError } from '@clocky/clocky-attachment'
import type { AttachmentStore, ImageAttachmentRef, ImageMediaType, SaveImageAttachment } from '@clocky/clocky-attachment'
import type { ContentBlock } from '@clocky/clocky-llm'
import type { ToolDefinition, ToolExecution, ToolExecutionResult } from '@clocky/clocky-tools'
import { assertSupportedJsonSchema } from '@clocky/clocky-tools'
import type { JsonSchemaNode, JsonValue } from '@clocky/clocky-tools'
...
/**
 * Model function-name contract: at most 64 characters. Wire-protocol
 * constant, not configuration.
 */
const MAX_PUBLIC_NAME_LENGTH = 64

/** Model function-name contract: only `[A-Za-z0-9_-]` is allowed. */
 ...
 * truncation to the model function-name contract (64 chars,
