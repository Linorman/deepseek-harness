 ...
 * @module @clocky/clocky-compat-subagent-in-process-driver/structured
 */

import type { Context } from '@clocky/cordis'
import type { ToolSchema } from '@clocky/clocky-llm'
import type { ToolExecution, ToolRunContext } from '@clocky/clocky-tools'
import { ToolArgsError, validateJsonSchemaValue, type ObjectJsonSchema } from '@clocky/clocky-tools'
 ...
 *   `assertObjectJsonSchema` in clocky-tools).
