...
import { STRUCTURED_OUTPUT_TOOL } from '@clocky/clocky-compat-subagent-in-process-driver'
import * as spawn from '@clocky/clocky-compat-subagent-spawn-in-process'
...
describe('clocky-tool-ralph over the real spawn and worker-thread stack', () => {
