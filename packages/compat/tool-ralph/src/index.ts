 ...
 * @module @clocky/clocky-compat-tool-ralph
 */
...
import type { SubagentProvider } from '@clocky/clocky-compat-subagent'
import { defineTool } from '@clocky/clocky-tools'
import type { ToolCallView, ToolResultView } from '@clocky/clocky-tools'
import type { WorkflowResult, WorkflowRun } from '@clocky/clocky-compat-workflow'
...
function presentCall(args: RalphCallArgs): ToolCallView {
  return { card: 'generic', title: 'legacy_ralph', rawInput: args.objective }
}
