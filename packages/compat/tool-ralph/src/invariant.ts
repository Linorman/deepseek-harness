/**
 * Package-owned invariant companion for `@clocky/clocky-compat-tool-ralph`.
 * @module @clocky/clocky-compat-tool-ralph/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-compat-tool-ralph'
