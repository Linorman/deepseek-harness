/**
 * Package-owned invariant companion for `@clocky/clocky-compat-subagent-clocky-sdk`.
 * @module @clocky/clocky-compat-subagent-clocky-sdk/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-compat-subagent-clocky-sdk'
