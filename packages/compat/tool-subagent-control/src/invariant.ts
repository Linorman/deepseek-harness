/**
 * Package-owned invariant companion for `@clocky/clocky-compat-tool-subagent-control`.
 * @module @clocky/clocky-compat-tool-subagent-control/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-compat-tool-subagent-control'
