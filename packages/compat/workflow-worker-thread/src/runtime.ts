 ...
 * @module @clocky/clocky-compat-workflow-worker-thread/runtime
 */

import * as vm from 'node:vm'
import type { ContentBlock } from '@clocky/clocky-llm'
import { SessionId } from '@clocky/clocky-session'
import { assertObjectJsonSchema, JsonSchemaError } from '@clocky/clocky-tools'
import type { ObjectJsonSchema } from '@clocky/clocky-tools'
import { isFatalWorkflowError, WorkflowError } from '@clocky/clocky-compat-workflow'
import type {
