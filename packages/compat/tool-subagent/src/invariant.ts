/**
 * Package-owned invariant companion for `@clocky/clocky-compat-tool-subagent`.
 * @module @clocky/clocky-compat-tool-subagent/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-compat-tool-subagent'
