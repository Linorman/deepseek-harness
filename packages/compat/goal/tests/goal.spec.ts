...
import { createUserMessage, HarnessError } from '@clocky/clocky-llm'
import SessionStore, { Session, SessionId, type UserMessage } from '@clocky/clocky-session'
import GoalService, {
  GoalError,
  GoalId,
  decodeGoalChange,
  foldGoal,
} from '@clocky/clocky-compat-goal'
import type { GoalChangeMeta, GoalRef, GoalSnapshotChangeMeta } from '@clocky/clocky-compat-goal'
...
function stubAgent(rawId: string, seed?: readonly import('@clocky/clocky-session').SessionEvent[]): StubAgent {
