/**
 * Package-owned invariant companion for `@clocky/clocky-compat-command-goal`.
 * @module @clocky/clocky-compat-command-goal/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-compat-command-goal'
