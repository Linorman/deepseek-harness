...
import type { SessionProjectionRegistry } from '@clocky/clocky-session-projection'
import type { SessionProjectionCache } from '@clocky/clocky-session-projection-cache'
...
async function prepareListing(
  ...
  if (projections === undefined) {
    throw new SubagentError(
      'listing subagents requires the sessionProjections registry (load @clocky/clocky-session-projection)',
  ...
  if (sessions === undefined) {
    throw new SubagentError(
      'listing subagents requires the session store (load @clocky/clocky-session)',
