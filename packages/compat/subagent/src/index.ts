 ...
 * (`@clocky/clocky-compat-subagent-spawn-in-process`, `-fork`, `-acp`) and the model-facing
 * consumer (`@clocky/clocky-compat-tool-subagent`) are separate packages.
 *
 ...
 *
 * @module @clocky/clocky-compat-subagent
 */
...
import { assertObjectJsonSchema } from '@clocky/clocky-tools'
import type { ContentBlock, MessageId } from '@clocky/clocky-llm'
