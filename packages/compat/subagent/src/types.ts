 ...
 *
 * @module @clocky/clocky-compat-subagent/types
 */

import type { Agent, AgentOptions } from '@clocky/clocky-agent'
...
import type { ObjectJsonSchema, ToolRestriction } from '@clocky/clocky-tools'
