/** Package-owned subagent registry and lifecycle invariants. @module @clocky/clocky-compat-subagent/invariant */
...
const PACKAGE_NAME = '@clocky/clocky-compat-subagent'
