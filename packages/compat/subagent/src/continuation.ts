...
import { boundContextSummary, createUserMessage, errorChain } from '@clocky/clocky-llm'
import type { ContentBlock, MessageId, MessageSource } from '@clocky/clocky-llm'
...
import type { ToolRestriction } from '@clocky/clocky-tools'
...
export class SubagentContinuationManager {
  ...
  private requirePersistence(): SessionPersistence {
    ...
    if (persistence === undefined) {
      throw new SubagentError(
        'continuable subagents require session persistence (load a clocky-session-persistence backend)',
