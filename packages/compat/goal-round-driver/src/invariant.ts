/** Package-owned goal-round prompt invariants. @module @clocky/clocky-compat-goal-round-driver/invariant */

import { isDeepStrictEqual } from 'node:util'
import type { Context } from '@clocky/cordis'
import { foldGoal, type FoldedGoal, type GoalMessageSource, type GoalView } from '@clocky/clocky-compat-goal'
...
const PACKAGE_NAME = '@clocky/clocky-compat-goal-round-driver'
