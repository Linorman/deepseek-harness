 ...
 * @module @clocky/clocky-compat-goal-round-driver
 */

import { isDeepStrictEqual } from 'node:util'
import { FiberState } from '@clocky/cordis'
import type { Context } from '@clocky/cordis'
import type { Agent, PreStepDecision } from '@clocky/clocky-agent'
import type { GoalMessageSource, GoalRef, GoalView } from '@clocky/clocky-compat-goal'
