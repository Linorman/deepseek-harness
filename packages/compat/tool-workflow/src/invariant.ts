/** Package-owned durable workflow-record invariants. @module @clocky/clocky-compat-tool-workflow/invariant */
...
const PACKAGE_NAME = '@clocky/clocky-compat-tool-workflow'
