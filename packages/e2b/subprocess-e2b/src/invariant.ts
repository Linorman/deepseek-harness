/**
 * Package-owned invariant companion for `@clocky/clocky-subprocess-e2b`.
 * @module @clocky/clocky-subprocess-e2b/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-subprocess-e2b'
