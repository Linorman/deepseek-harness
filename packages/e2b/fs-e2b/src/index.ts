...
import type { EntryInfo, Sandbox } from '@clocky/clocky-e2b'

const VERSION_METADATA_KEY = 'clocky-version'
...
export class E2BFileSystem extends FileSystem {
  ...
  private async writeAtomic(
    ...
    const stagingDirectory = posix.join(posix.dirname(targetPath), `.clocky-${randomUUID()}.tmp`)
