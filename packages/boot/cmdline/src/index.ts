/**
 * @clocky/clocky-cmdline — the command line a clocky launcher hands to the app
 * it boots.
 *
 ...
 * verbatim and in argv order. `clocky --profile tui --resume abc` yields
 * `['--resume', 'abc']`.
 */
