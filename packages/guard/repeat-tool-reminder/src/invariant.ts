/**
 * Package-owned invariant companion for `@clocky/clocky-repeat-tool-reminder`.
 * @module @clocky/clocky-repeat-tool-reminder/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-repeat-tool-reminder'
