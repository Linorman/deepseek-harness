/**
 * Unit + real-load-path coverage for @clocky/clocky-tool-call-timeout-policy. The
...
import { CallId, HarnessError } from '@clocky/clocky-llm'
import SystemPrompt from '@clocky/clocky-system-prompt'
import ToolRuntime, { defineContentToolFixture, TOOL_ABORTED, type ToolExecutionInput, type PostToolDecision } from '@clocky/clocky-tools'
import * as timeoutPolicy from '@clocky/clocky-tool-call-timeout-policy'
import { TOOL_TIMEOUT } from '@clocky/clocky-tool-call-timeout-policy'
...
describe('clocky-tool-call-timeout-policy real-load-path guard', () => {
