 ...
 *
 * @module @clocky/clocky-agent-instructions/render
 */
...
/**
 * File name of the single user-global instruction file under `$CLOCKY_HOME`.
 * Discovery (`$CLOCKY_HOME/<name>`) and reconciliation (the user-global scope key's
...
export function scopeForDisplayPath(displayPath: string): string {
  if (displayPath === '~/.clocky/AGENTS.md' || displayPath === '$CLOCKY_HOME/AGENTS.md') return USER_GLOBAL_DIRECTORY
