/**
 * Package-owned invariant companion for `@clocky/clocky-session-reference`.
 * @module @clocky/clocky-session-reference/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-session-reference'
