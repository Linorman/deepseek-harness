 ...
 * @module @clocky/clocky-session-reference/types
 */

import type { UserMessage } from '@clocky/clocky-llm/message'
...
export interface SessionReferenceMentionCandidate extends SessionReferenceCandidate {
  /** Canonical `@[label](clocky-session:…)` mention serialized into the prompt draft. */
  mention: string
}
