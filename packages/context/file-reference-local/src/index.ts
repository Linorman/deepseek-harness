 ...
 *
 * @module @clocky/clocky-file-reference-local
 */
...
} from '@clocky/clocky-file-reference'
...
export { FILE_REFERENCE_PROMPT } from '@clocky/clocky-file-reference'
export { activeAtToken, formatFileMention } from '@clocky/clocky-file-reference/grammar'
