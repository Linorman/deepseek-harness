/**
 * Package-owned invariant companion for `@clocky/clocky-tmux-context`.
 * @module @clocky/clocky-tmux-context/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-tmux-context'
