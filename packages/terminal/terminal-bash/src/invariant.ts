/**
 * Package-owned invariant companion for `@clocky/clocky-terminal-bash`.
 * @module @clocky/clocky-terminal-bash/invariant
 */
...
const PACKAGE_NAME = '@clocky/clocky-terminal-bash'
