...
class ClockyConfig:
    ...
    intentionally override or inject the variables named by the selected
    Cordis composition.
    """
...
class Clocky:
    """Reusable synchronous SDK for running Clocky agent turns.
...
class Session:
    def __init__(self, harness: Clocky, session_id: str) -> None:
