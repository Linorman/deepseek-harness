...
- Human slash-command discovery and rendering are owned by the separate [`clocky-command-goal`](../../../../packages/compat/command-goal/README.md) plugin.
