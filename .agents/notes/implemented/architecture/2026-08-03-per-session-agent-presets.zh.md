...
**把每个 preset 作为子进程运行。** [`subagent-clocky-sdk`](../../../../packages/compat/subagent-clocky-sdk/README.zh.md) 已经证明完整的子 harness 可行，隔离性也会是绝对的。但这同时意味着要按会话代理流式输出、审批与投影，那是一个传输层项目，而非组装问题。
