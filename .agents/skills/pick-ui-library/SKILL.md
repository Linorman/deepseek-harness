...
1. **Identify the requested task and constraints.** Preserve an explicitly selected library. Use the curated defaults when the user asks you to choose; do not replace a named library merely because another appears in this list.
