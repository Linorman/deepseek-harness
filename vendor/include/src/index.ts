import { EntryGroup, EntryTree, isJsExpr, type EntryOptions } from '@clocky/cordis-plugin-loader'
 ...
 * (`clocky --dump-config`) parses and prints exactly the dialect this include
 * mounts.
 */
 ...
 * (`clocky --dump-config`) so a dump can never drift from what boots. The input
