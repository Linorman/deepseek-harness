...
const SESSION_PACKAGE = '@clocky/clocky-session'
 ...
 * top-level declaration (in `@clocky/clocky-session`) and any declaration
 * merge inside a `declare module '@clocky/clocky-session/types'` block. Both forms
...
export function renderKnownEventTypes(events: AnnotatedLogEventEntry[]): string {
  ...
  return [
    ...
    ' * @module @clocky/clocky-session/known-event-types',
    ' */',
    '',
    '/**',
