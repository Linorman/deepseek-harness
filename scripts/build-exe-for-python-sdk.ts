...
const DEPLOY_ROOT_PACKAGE = 'clocky-jsonrpc-agent-pkg'
/** The closed-runtime app entry inside the deployed closure. */
const ENTRY_BIN = 'node_modules/@clocky/clocky-sdk-jsonrpc-demo/lib/packaged-bin.js'
const OUTPUT_BASENAME = 'clocky-jsonrpc-agent-pkg'
...
const PYTHON_RUNTIME_DIR = 'python/sdk-runtime/src/clocky_runtime/runtime'
