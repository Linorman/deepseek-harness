...
function checkManifest(
  ...
  if (owner.packageName === '@clocky/clocky-invariants') return
  if (manifest.peerDependencies?.['@clocky/clocky-invariants'] !== 'workspace:^') {
    addViolation(
      violations,
      owner.manifestPath,
      '@clocky/clocky-invariants must be a workspace:^ peerDependency',
    )
  }
  if (manifest.devDependencies?.['@clocky/clocky-invariants'] !== 'workspace:^') {
    addViolation(
      violations,
      owner.manifestPath,
      '@clocky/clocky-invariants must also be a workspace:^ devDependency',
    )
  }
}
...
function checkBuild(
  ...
  if (owner.packageName !== '@clocky/clocky-invariants'
