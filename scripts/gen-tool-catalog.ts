...
import type { ToolSchema } from '@clocky/clocky-llm'
...
import { PwshLocalExecutor } from '@clocky/clocky-pwsh-local'
...
import PlanModeController from '@clocky/clocky-plan-mode'
...
import * as ToolAskUser from '@clocky/clocky-tool-ask-user'
import * as ToolBash from '@clocky/clocky-tool-bash'
import * as ToolPwsh from '@clocky/clocky-tool-pwsh'
import * as ToolBashPersistent from '@clocky/clocky-tool-bash-persistent'
import * as ToolPwshPersistent from '@clocky/clocky-tool-pwsh-persistent'
...
import * as ToolFsSearch from '@clocky/clocky-tool-fs-search'
...
const TOOL_PACKAGES: ToolPackage[] = [
  {
    pkg: '@clocky/clocky-tool-ask-user',
    dir: 'tool-ask-user',
  ...
  {
    pkg: '@clocky/clocky-tool-bash-persistent',
  ...
  {
    pkg: '@clocky/clocky-tool-pwsh-persistent',
  ...
  {
    pkg: '@clocky/clocky-tool-str-replace-editor',
  ...
  {
    pkg: '@clocky/clocky-tool-fs-search',
    dir: 'tool-fs-search',
  ...
  {
    pkg: '@clocky/clocky-tool-terminal',
    dir: 'tool-terminal',
  ...
  },
  {
    ...
    async mount(ctx) {
      ...
      await ctx.plugin(SkillFileSystem, {
        clockyHome: resolve(root, '.tmp/tool-catalog/.clocky'),
  ...
  {
    pkg: '@clocky/clocky-tool-session-query',
