...
import { boot, loadOverlayPatches } from '@clocky/clocky-app-boot'
import SystemPrompt from '@clocky/clocky-system-prompt'
import ToolRuntime from '@clocky/clocky-tools'
import * as McpClient from '@clocky/clocky-mcp-client/src/index.ts'
...
describe('third-party memory MCP example overlays', () => {
  it.each(examples)('parses $file with the documented generic plugin fields', (contract) => {
    ...
    expect(row.name).toBe('@clocky/clocky-mcp-client')
