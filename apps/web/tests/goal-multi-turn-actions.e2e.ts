...
import type {} from '@clocky/clocky-goal'
import {
...
const PACKAGE_FILES: Readonly<Record<string, string>> = {
  ...
  'packages/client/ui-conversation/package.json': '{"name":"@clocky/clocky-client-ui-conversation"}\n',
  ...
  'packages/context/session-reference/package.json': '{"name":"@clocky/clocky-session-reference"}\n',
  ...
  'packages/llm/token-meter/package.json': '{"name":"@clocky/clocky-token-meter"}\n',
  ...
  'packages/skill/skill-filesystem/package.json': '{"name":"@clocky/clocky-skill-filesystem"}\n',
