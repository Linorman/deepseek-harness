...
| --- | --- | --- | --- |
| `@clocky/cosmokit` | `cosmokit` | [github.com/clocky/cosmokit](https://github.com/clocky/cosmokit) | MIT |
| `@clocky/schemastery` | `schemastery` | [github.com/clocky/schemastery](https://github.com/clocky/schemastery) | MIT |
| `@clocky/cordis` | `cordis` | [github.com/cordiverse/cordis](https://github.com/cordiverse/cordis) | MIT |
| `@clocky/cordis-plugin-loader` | `@cordisjs/plugin-loader` | [github.com/cordiverse/cordis](https://github.com/cordiverse/cordis) | MIT |
| `@clocky/cordis-plugin-include` | `@cordisjs/plugin-include` | [github.com/clocky/cordis](https://github.com/clocky/cordis) | MIT |
| `@clocky/cordis-plugin-group` | `@cordisjs/plugin-group` | [github.com/clocky/cordis](https://github.com/clocky/cordis) | MIT |
| `@clocky/cordis-plugin-timer` | `@cordisjs/plugin-timer` | [github.com/clocky/cordis](https://github.com/clocky/cordis) | MIT |
| `@clocky/cordis-plugin-hmr` | `@cordisjs/plugin-hmr` | [github.com/clocky/cordis](https://github.com/clocky/cordis) | MIT |
| `@clocky/cordis-plugin-logger-console` | `@cordisjs/plugin-logger-console` | [github.com/clocky/cordis](https://github.com/clocky/cordis) | MIT |
...
`eslint-plugin-sonarjs` (LGPL-3.0-only) and `lightningcss` (MPL-2.0) run only as development tooling; their code is not linked into or distributed with any Clocky artifact.
...
| [`pydantic`](https://github.com/pydantic/pydantic) | MIT | runtime dependency of `clocky-sdk` |
